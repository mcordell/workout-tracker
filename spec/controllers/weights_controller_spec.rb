  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created weight as @weight" do
        post :create, {:weight => valid_attributes}, valid_session
        expect(assigns(:weight)).to be_a(Weight)
        expect(assigns(:weight)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved weight as @weight" do
        post :create, {:weight => invalid_attributes}, valid_session
        expect(assigns(:weight)).to be_a_new(Weight)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested weight" do
        weight = Weight.create! valid_attributes
        put :update, {:id => weight.to_param, :weight => new_attributes}, valid_session
        weight.reload
    ...
    describe "with invalid params" do
      it "assigns the weight as @weight" do
        weight = Weight.create! valid_attributes
        put :update, {:id => weight.to_param, :weight => invalid_attributes}, valid_session
        expect(assigns(:weight)).to eq(weight)
      end
